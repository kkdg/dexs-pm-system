		...
		<table class="pm_table">
			<thead>
				<tr valign="top">
					...
					<th style="width: 30%;" class="manage-column"><?php echo $first_td; ?></th>
					<th style="width: 50%;" class="manage-column"><?php _e('Subject', 'dexs-pm'); ?></th>
					<th style="width: 19%;" class="manage-column"><?php _e('Date', 'dexs-pm'); ?></th>
				</tr>
			</thead>
