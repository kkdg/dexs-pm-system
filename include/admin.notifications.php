	...
	<?php if(!$dexsPM->load_pm_settings("settings", "email_note")){ ?>		
		<div id="settings-error-settings_updated" class="error settings-error">
			<p><?php _e('<b>Error:</b> The eMail Notification System is disabled! You can activate the System under the "General Settings" Tab.', 'dexs-pm'); ?></p>
		</div>
	<?php } ?>
	
	<form action="" method="post">	
		<h3><?php _e('eMail Notification Configruation', 'dexs-pm'); ?></h3>
		<p class="description"><?php _e('The eMail Message will be stored in the <code>mail.php</code> file, in the plugin directory.', 'dexs-pm'); ?></p><br>
